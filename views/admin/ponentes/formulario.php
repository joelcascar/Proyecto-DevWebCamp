...
<fieldset class="formulario__fieldset">
    ...
    <div class="formulario__campo">
        <div class="formulario__contenedor-icono">
            ...
            <input type="text" class="formulario__input--sociales" name="redes[twitter]" placeholder="X (antes twitter)" value="<?php echo $ponente->twiiter ?? ''; ?>">
        </div>
    </div>
    ...
    <div class="formulario__campo">
        <div class="formulario__contenedor-icono">
            ...
            <input type="text" class="formulario__input--sociales" name="redes[instagram]" placeholder="Instagram" value="<?php echo $ponente->youtube ?? ''; ?>">
        </div>
    </div>
